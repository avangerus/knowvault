...
// TestQuestionRunCancellationPersistsCancelled proves that a request cancellation
// after the run is committed still leaves a distinct terminal status and one failure
...
func TestQuestionRunCancellationPersistsCancelled(t *testing.T) {
