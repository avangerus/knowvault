...
var openAPIRoutes = map[endpointKind]describedRoute{
	...
	endpointSourceDiscoveryRegisterBatch:  {"/sources/discovery/{request_id}:register-batch", "endpointSourceDiscoveryRegisterBatch"},
	...
	endpointManagedSourceConfirmBatch:     {"/workspaces/{workspace_id}/managed-source-confirmations:batch", "endpointManagedSourceConfirmBatch"},
	...
	endpointQuestionFeedback:              {"/workspaces/{workspace_id}/questions/{question_run_id}:feedback", "endpointQuestionFeedback"},
	endpointQuestionFeedbackReport:        {"/workspaces/{workspace_id}/questions:feedback-report", "endpointQuestionFeedbackReport"},
}
