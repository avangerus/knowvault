-- Stage 3 source-status observability.
-- Keep workspace_source_status and workspace_source_status_v2 unchanged for
-- compatibility; this projection adds only the durable-job and freshness
-- facts needed by the existing source-status surface.
