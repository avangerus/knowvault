...
async function main(): Promise<void> {
  ...
  check(sameSet(liveReceiptTags, ["observation_window", "receipt_digest", "receipts", "source_id"]), `live receipt contract ${JSON.stringify(sorted(liveReceiptTags))} does not match the additive receipt fields`);
